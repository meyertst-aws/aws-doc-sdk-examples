...
static const Aws::String FILE_NAME{MEDIA_DIR "/test_audio.wav"};
static const int SAMPLE_RATE = 48000; // for the file above
...
int main() {
    ...
    Aws::InitAPI(options);
    {
        ...
        handler.SetMedicalTranscriptEventCallback([](const MedicalTranscriptEvent &ev) {
        ...
        request.SetSpecialty(Specialty::PRIMARYCARE);
        request.SetType(Type::CONVERSATION);
        ...
        auto OnResponseCallback = [&signaling](
                ...
                const Model::StartMedicalStreamTranscriptionRequest & /*unused*/,
                const Model::StartMedicalStreamTranscriptionOutcome &outcome,
        ...
        client.StartMedicalStreamTranscriptionAsync(request, OnStreamReady, OnResponseCallback,
                                             nullptr /*context*/);
